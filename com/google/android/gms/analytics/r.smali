...
.method private declared-synchronized ei()V
    ...
    invoke-interface {v1}, Lcom/google/android/gms/analytics/f;->dP()Ljava/util/concurrent/LinkedBlockingQueue;
    ...
    invoke-virtual {v6}, Lcom/google/android/gms/analytics/r$d;->en()Ljava/util/Map;

    move-result-object v2

    invoke-virtual {v6}, Lcom/google/android/gms/analytics/r$d;->eo()J
    ...
    invoke-virtual {v6}, Lcom/google/android/gms/analytics/r$d;->ep()Ljava/util/List;
