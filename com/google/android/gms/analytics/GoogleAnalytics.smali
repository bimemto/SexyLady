...
.method private constructor <init>(Landroid/content/Context;Lcom/google/android/gms/analytics/f;Lcom/google/android/gms/analytics/ae;)V
    ...
    invoke-direct {p0}, Lcom/google/android/gms/analytics/GoogleAnalytics;->eF()V
...
.method static eE()Lcom/google/android/gms/analytics/GoogleAnalytics;
    .locals 2
...
.method a(Lcom/google/android/gms/analytics/v;)V
    ...
    invoke-virtual {p1}, Lcom/google/android/gms/analytics/v;->eu()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p1}, Lcom/google/android/gms/analytics/v;->ev()Ljava/lang/String;
    ...
    :cond_0
    invoke-virtual {p1}, Lcom/google/android/gms/analytics/v;->ew()Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-virtual {p1}, Lcom/google/android/gms/analytics/v;->ex()Ljava/lang/String;
    ...
    :cond_1
    invoke-virtual {p1}, Lcom/google/android/gms/analytics/v;->ey()Z

    move-result v0

    if-eqz v0, :cond_2

    invoke-virtual {p1}, Lcom/google/android/gms/analytics/v;->ez()Ljava/lang/String;
    ...
    :cond_2
    invoke-virtual {p1}, Lcom/google/android/gms/analytics/v;->eA()Z
    ...
    invoke-virtual {p1}, Lcom/google/android/gms/analytics/v;->eB()I
    ...
    invoke-virtual {p1}, Lcom/google/android/gms/analytics/v;->eD()Z
...
.method public setAppOptOut(Z)V
    ...
    invoke-interface {v0}, Lcom/google/android/gms/analytics/f;->dI()V
...
.method u(Ljava/util/Map;)V
    ...
    invoke-virtual {v1}, Lcom/google/android/gms/analytics/t;->es()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lcom/google/android/gms/analytics/t;->er()Ljava/lang/String;
