...
.field final Te:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
...
.method constructor <init>(IIILjava/util/List;Z)V
    ...
    iput p2, p0, Lcom/google/android/gms/fitness/data/RawDataSet;->Tb:I

    iput p3, p0, Lcom/google/android/gms/fitness/data/RawDataSet;->Td:I

    iput-object p4, p0, Lcom/google/android/gms/fitness/data/RawDataSet;->Te:Ljava/util/List;

    iput-boolean p5, p0, Lcom/google/android/gms/fitness/data/RawDataSet;->Sy:Z
...
.method public constructor <init>(Lcom/google/android/gms/fitness/data/DataSet;Ljava/util/List;Ljava/util/List;)V
    ...
    iput-object v0, p0, Lcom/google/android/gms/fitness/data/RawDataSet;->Te:Ljava/util/List;

    invoke-virtual {p1}, Lcom/google/android/gms/fitness/data/DataSet;->iB()Z

    move-result v0

    iput-boolean v0, p0, Lcom/google/android/gms/fitness/data/RawDataSet;->Sy:Z
    ...
    iput v0, p0, Lcom/google/android/gms/fitness/data/RawDataSet;->Tb:I
    ...
    iput v0, p0, Lcom/google/android/gms/fitness/data/RawDataSet;->Td:I
...
.method private a(Lcom/google/android/gms/fitness/data/RawDataSet;)Z
    ...
    iget v0, p0, Lcom/google/android/gms/fitness/data/RawDataSet;->Tb:I

    iget v1, p1, Lcom/google/android/gms/fitness/data/RawDataSet;->Tb:I

    if-ne v0, v1, :cond_0

    iget v0, p0, Lcom/google/android/gms/fitness/data/RawDataSet;->Td:I

    iget v1, p1, Lcom/google/android/gms/fitness/data/RawDataSet;->Td:I

    if-ne v0, v1, :cond_0

    iget-boolean v0, p0, Lcom/google/android/gms/fitness/data/RawDataSet;->Sy:Z

    iget-boolean v1, p1, Lcom/google/android/gms/fitness/data/RawDataSet;->Sy:Z

    if-ne v0, v1, :cond_0

    iget-object v0, p0, Lcom/google/android/gms/fitness/data/RawDataSet;->Te:Ljava/util/List;

    iget-object v1, p1, Lcom/google/android/gms/fitness/data/RawDataSet;->Te:Ljava/util/List;
...
.method public hashCode()I
    ...
    iget v2, p0, Lcom/google/android/gms/fitness/data/RawDataSet;->Tb:I
    ...
    iget v2, p0, Lcom/google/android/gms/fitness/data/RawDataSet;->Td:I
...
.method public toString()Ljava/lang/String;
    ...
    iget v3, p0, Lcom/google/android/gms/fitness/data/RawDataSet;->Tb:I
    ...
    iget v3, p0, Lcom/google/android/gms/fitness/data/RawDataSet;->Td:I
    ...
    iget-object v3, p0, Lcom/google/android/gms/fitness/data/RawDataSet;->Te:Ljava/util/List;
